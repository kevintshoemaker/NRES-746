...
as.numeric( Prob_Color["blue"] + Prob_Shape["cube"] - (allTypes/sum(allTypes))["cube","blue"]   )     # not mutually exclusive
...
Now we can express the joint probability of drawing a blue cube in terms of conditional probabilities!
...
**Q**: Can you interpret the above equation in words? Take a moment to try!
...
Suppose there is a test that never gives a false negative (if you've got it you will test positive) but occasionally gives a false positive result (if you don't got it, you still might still test positive for the disease). Let's imagine a very low false positive rate of 1%. 
...
**Q**: What's the the *joint probability* of being infected and testing positive?
...
This simple rule of probability is actually at the core of **Bayesian statistics**!!
...
Let's say our hypothesis is that the prize is behind door 1 -- we can call this the "stay" hypothesis, because if we believed this were the case, we had better well keep door 1 as our choice and not switch to door 3! 

As for the **priors** (knowledge about which door the prize is behind at the beginning of the game), let's assign a _uniform distribtuion_ (equal probability mass assigned to all possibilities). So the **prior** probability of the prize being behind door 1 is $\frac{1}{3}$.     
