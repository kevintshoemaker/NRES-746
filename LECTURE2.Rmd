...
**Moments** – descriptions of the distribution. For a bounded probability distribution, the collection of all the moments (of all orders, from 0 to $\infty$) uniquely determines the shape of the distribution.  
