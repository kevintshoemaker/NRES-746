...
We will use Simon Wood's free 'Core Statistics' textbook as a more rigorous math-stats text: [link here](https://webhomes.maths.ed.ac.uk/~swood34/core-statistics.pdf). I will also draw examples from Simon Wood's "Generalized Additive Models: an introduction with R" (and I highly recommend buying this book!).  
