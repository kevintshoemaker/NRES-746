...
NOTE: you should re-install the package for every lab, since I'll be updating frequently. For example, the package currently only includes lab 1 (and old versions of labs 2-4).
