...
+ **input**:         
    + MCMC1 = the object generated from running the 'samples()' function with the Ricker formulation.     
    + MCMC2 = the object generated from running the 'samples()' function with the Michaelis-Menten formulation.
