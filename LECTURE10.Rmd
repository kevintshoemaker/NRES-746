...
2. Using this bootstrap sample, build a *decision tree*. At each node of the decision tree, select splitting rules from a small subset of the available predictor variables (features).    
