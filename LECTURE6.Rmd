...
In MLE, we by definition try to find the parameter value that maximizes the likelihood function. Why don't we use the mode of the likelihood function? In Bayesian analysis, why don't we use the mode of the posterior distribution?
