...
In practical terms, you can think of the denominator, $P(D)$, as a normalizing constant that effectively converts the weighted likelihood in the numerator $P(D|\theta)\cdot P(\theta))$ into a true probability distribution. 
