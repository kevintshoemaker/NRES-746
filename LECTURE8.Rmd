...
This AIC table shows us that the simplest model is best! Despite the fact that the deviance is lowest for the full model! (principle of parsimony dictates at work) 
...
What is the marginal likelihood of observing any particular data from 0 to 10? Intuitively, because *p* could take any possible value, we know that the marginal likelihood of any particular data observation should be the same as any other observation. Therefore, since there are 11 possibilities, the marginal likelihood of any particular data observation should be 1/11.
...
What are the odds in favor of the more complex model in this case?
