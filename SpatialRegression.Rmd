...
```{r PrevalenceMap, fig.cap="Figure 1: Map of Malaria Prevalence in The Gambia"}
...
```{r RasterData, fig.cap="Figure 2: Elevation in The Gambia. Data source SRTM."}
...
```{r MyRaster, fig.cap="Figure for lab: Map of my_raster, you can choose a different variable for your fixed effect and map it."}
# For the lab-part 2, "MyRaster" ----
...
```{r TriangulatedMesh, fig.cap="Figure 2: Triangulated Mesh used for the SPDE model."}
### Build the mesh ----
...
```{r MapPredictedPrevalence, fig.cap="Figure 3: Predicted prevalence of malaria in The Gambia, shown as points."}
...
```{r RasterizePrediction, fig.cap="Figure 4: Raster of predicted prevalence of malaria."}
...
```{r LowerLimits, fig.cap="Figure 5: Lower prediction limits."}
...
leaflet() %>%
  ...
  addScaleBar(position = c("bottomleft"))
```
```{r UpperLimits, fig.cap="Figure 6: Upper prediction limits."}
### Lower limits of prediction
...
```{r ExceedanceProbabilities, fig.cap="Figure 7: Malaria Exceedance Probabilities for The Gambia, level=20%"}
## For the lab-part 4 ----
