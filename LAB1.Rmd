...
Note that, although the normal distribution is the only distribution that is fully determined by its mean and variance, all probability distributions have a mean and variance (although some distributions 'misbehave' and have infinite mean and/or variance!).  
...
+ **input**:    
    ...
    + nulldata = a vector of observations under the null hypothesis (empirical null distribution)
