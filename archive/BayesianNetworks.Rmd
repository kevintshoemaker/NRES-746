...
author: "Laura Cirillo, Cortney Hulse, Rosie Perash"
date: "11/18/2018"
output: 
  html_document: 
    theme: cerulean
...
For those wishing to follow along with the R-based demo in class, [click here](BayesianNetworks.R) for the companion R script for this lecture.

Also, [click here](BayesianNetworks.pptx) for the PPT slides!
