...
If you'd like to follow along in R, you can download the script here: [neuralNet.R](neuralNet.R)

All of the materials for this lecture/demo are also available on [GitHub](https://github.com/keaneflynn/NeuralNetworks) 
...
[Click here to download the data for this example](nhseData.csv)
...
4. Humane Society Of The United States. The Humane Society of the United States . United States, 2001.