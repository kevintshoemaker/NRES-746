...
```{r blank-histogram, fig.height=4, fig.width=5}
...
Each shape above comes from a general equation, with letters ($a$, $b$, ...) standing in for numbers we haven't chosen yet:
