...
**Introduction:** Provide enough description so that the reader understands why the research is important and (if appropriate) what research question(s) and/or hypotheses are being addressed. (approx. 3 paragraphs)
...
#### Group project overview (1 page, due 9/27)  
...
## Group project oral presentations (in class, 12/10/19)
...
## Group project final draft (due Fri 12/6/19)

## Group project final paper (due Wed 12/18/19)
