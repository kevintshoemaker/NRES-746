...
[age.data1.csv](age.data1.csv)         
[wideSample.csv](wideSample.csv)          
[narrowSample.csv](narrowSample.csv)        
[SnowEx17_GPR_Week1_transects.txt](SnowEx17_GPR_Week1_transects.txt)      
[AutoCovRaster.tif](AutoCovRaster.tif)      
...
- Unfortunately we don't always have data that looks this clean. Here's another example. To run this code, you will need [this data file](SnowEx17_GPR_Week1_transects.txt)
...
<br>
Suppose we want to find the relationship between a tree species' height and its age. We go out and record the age, height, and location of sampled trees. To run the following sample code, you will need [this data](age.data1.csv) 
