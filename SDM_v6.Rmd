...
**NOTE:** for those wishing to follow along with the R-based demo in class, [click here](SDM_v5.R) for an R-script that contains all of the code blocks in this lecture. 
